...
export class TMath extends Contract {
  ...
  estimateGas: {
    ...
    calc_btoi(a: BigNumberish): Promise<BigNumber>;
    calc_bfloor(a: BigNumberish): Promise<BigNumber>;
    calc_badd(a: BigNumberish, b: BigNumberish): Promise<BigNumber>;
    calc_bsub(a: BigNumberish, b: BigNumberish): Promise<BigNumber>;
    calc_bsubSign(a: BigNumberish, b: BigNumberish): Promise<BigNumber>;
    calc_bmul(a: BigNumberish, b: BigNumberish): Promise<BigNumber>;
    calc_bdiv(a: BigNumberish, b: BigNumberish): Promise<BigNumber>;
    calc_bpowi(a: BigNumberish, n: BigNumberish): Promise<BigNumber>;
    calc_bpow(base: BigNumberish, exp: BigNumberish): Promise<BigNumber>;
    calc_bpowApprox(
      base: BigNumberish,
      exp: BigNumberish,
      precision: BigNumberish
  ...
  populateTransaction: {
    ...
    calc_btoi(a: BigNumberish): Promise<PopulatedTransaction>;
    calc_bfloor(a: BigNumberish): Promise<PopulatedTransaction>;
    calc_badd(a: BigNumberish, b: BigNumberish): Promise<PopulatedTransaction>;
    calc_bsub(a: BigNumberish, b: BigNumberish): Promise<PopulatedTransaction>;
    calc_bsubSign(
      a: BigNumberish,
      b: BigNumberish
    ): Promise<PopulatedTransaction>;
    calc_bmul(a: BigNumberish, b: BigNumberish): Promise<PopulatedTransaction>;
    calc_bdiv(a: BigNumberish, b: BigNumberish): Promise<PopulatedTransaction>;
    calc_bpowi(a: BigNumberish, n: BigNumberish): Promise<PopulatedTransaction>;
    calc_bpow(
      base: BigNumberish,
      exp: BigNumberish
    ): Promise<PopulatedTransaction>;
